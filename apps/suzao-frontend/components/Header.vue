  ...
  <header class="suzao-navbar">
    <div class="logo-box">
      ...
      <div class="down a attracting">
        <a class="a " href="page/technologyAndSupport">
          <img src="/public/static/page/technology-and-support/technology-and-support-btn.png" alt="" srcset="">
        </a>
        <div class="box">
          <a href="page/technologyAndSupport?tab=rnd">
            改性技术服务
          </a>
          <a href="page/technologyAndSupport?tab=ul">
            企业申请UL技术指导
          </a>
        </div>
      </div>
    ...
    <div class="nav-list">
      ...
      <div class="down a attracting">
        <a class="list" href="page/attracting-merchants?tab=settled"><span>
            产品与服务
          </span></a>
        <div class="box">
          <a href="page/attracting-merchants?tab=settled">
            代理商入驻服务
          </a>
          <a href="page/attracting-merchants?tab=app">
            材料智能助手APP
          </a>
        </div>
      </div>
      ...
      <div class="down a down-app">
        <a class="name list" href="page/attracting-merchants?tab=app">
    ...
    <div class="info">
      <div class="down">
        <a class="a quotation hot label vibrate" href="/page/merchant-registration">
          <img src="/public/static/page/pay/quotation-btn.png" alt="" srcset="">
        </a>
        <a class="a quotation hot label vibrate" href="/login?refer=/page/merchant-registration">
          <img src="/public/static/page/pay/quotation-btn.png" alt="" srcset="">
        </a>
      </div>
      ...
      <div class="down member2" :class="{ 'enterprise': isEnterprise }">
        <a class="name list" href="member">
          <span class="span"><img v-if="vipStatus === 'up'" src="/public/static/layout/icon-vip.png" alt="">
            用户中心
          </span>
        ...
        <div class="box">
          ...
          <div class="center">
            ...
            <a class="btn" href="page/merchant-registration">+ 发布商品</a>
          </div>
          <div class="member-btn bottom">
            ...
            <a class="name list" href="member/interest">
              我的会员
            </a>
