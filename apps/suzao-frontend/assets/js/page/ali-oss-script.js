 ...
 * ========================================================================================================================
 */
function callRecognizeBankCard(imageUrl, ALIBABA_CLOUD, callback) {
  ...
  const Action = 'RecognizeBusinessLicense'
  ...
  callApi(endpoint, Action, API_VERSION, params, ALIBABA_CLOUD, callback)
}
 ...
 * ========================================================================================================================
 */
function callApi(endpoint, action, version, params, ALIBABA_CLOUD, callback) {
  ...
  request_['AccessKeyId'] = ALIBABA_CLOUD.accessKeyId
  ...
  request_['SecurityToken'] = ALIBABA_CLOUD.securityToken
  // 业务参数，请参考具体的AI能力的API文档进行修改
  if (params) {
  ...
  callApiRequest(request_, API_HTTP_METHOD, endpoint, ALIBABA_CLOUD.accessKeySecret, callback)
}
...
function uploadToTempOss(ossStsToken, filePath, callback) {
  ...
  let objectName = `${ossStsToken.Data.AccessKeyId}/${getNonce(6)}/${fileName}`
  putObject(ins)
  async function putObject(data) {
    try {
      ...
      const result = await ossClient.put(objectName, data)
